...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action']) && in_array($_POST['action'], ['pin_sent', 'pin_verify'], true)) {
  ...
  $mid = '8167';
  $aid = '368204';
  $key = '2092b6612de2a69376e83ac1e2611ce7';
  $integrationId = '22';
  $partner_name = 'Mobiforu';
  $userId = '8167';
  ...
  if ($action === 'pin_verify') {
    ...
    $endpoint = 'https://api.offer18.com//api/af/otp_verify';
  } else {
    $endpoint = 'https://api.offer18.com//api/af/otp_gen';
  }
